...
class LatLngTest {
    ...
    fun distances_are_within_error_margins() {
        ...
        val a = LatLng(40.4742675f, -3.68750f)
        val b = LatLng(40.4741015f, -3.68681f)
        isClose(0.06f, a distanceTo b) //a - b are ~60 meters apart

        val c = LatLng(40.4323089f, -3.717562f)
        val d = LatLng(40.4295267f, -3.715498f)
        val e = LatLng(40.4279319f, -3.696077f)
